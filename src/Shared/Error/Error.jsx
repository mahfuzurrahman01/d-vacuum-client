    ...
    return (
        <section className="flex items-center h-full sm:p-16">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
                ...
                <Link rel="noopener noreferrer" to='/' className="px-8 py-3 font-semibold rounded  bg-violet-400  text-gray-100" style={{backgroundColor:'#83BD75'}}>Back to homepage</Link>
            </div>
        </section>
    );
};
