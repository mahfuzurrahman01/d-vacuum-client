...
const Footer = () => {
    return (
        <footer className="px-4 divide-y text-gray-100" style={{ backgroundColor: '#83BD75' }}>
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3">
                <a rel="noopener noreferrer" href="  " className="flex justify-center space-x-2 items-center lg:justify-start">
                    ...
                    <p className='text-xl font-semibold uppercase text-white font-serif'>vacuum</p>
                </a>
            </div>
        ...
        <div className="py-6 text-sm text-center    text-gray-100">© 2020 Mahfuzur01 Company Co. All rights reserved.</div>
    </footer>
    );
};
